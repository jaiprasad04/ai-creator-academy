...
* [`templates/examples/headshot-lighting-motion.gif`](templates/examples/headshot-lighting-motion.gif) — Image-to-Video headshot lighting motion loop ([headshot-lighting-motion.mp4](templates/examples/headshot-lighting-motion.mp4)).
